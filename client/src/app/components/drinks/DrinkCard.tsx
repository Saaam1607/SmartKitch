...
export default function DrinkCard({ item, isEditing, edit, handleCheckChange, handleTextChange, handleImageChange, handlePriceChange }: CardComponentProps<DrinkProp>) {
